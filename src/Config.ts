...
export class Config {
    ...
    public network: { host: string, port: number, trustProxy: boolean, remoteHost: string, remotePort: number } = { host: '127.0.0.1', port: 2500, trustProxy: false, remoteHost: '', remotePort: 0 };
