...
export class Config {
    ...
    public network: { host: string, port: number, trust_proxy: boolean, remoteHost: string, remotePort: number } = { host: '127.0.0.1', port: 2500, trust_proxy: false, remoteHost: '', remotePort: 0 };
